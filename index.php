...
<div class ="Container-fluid sub_section pt-5 pb-5" id="aboutid" >
    ...
    <div class="row pt-5" >
        <div class ="col-lg-5 col md-6 col-12 ml-5 about_res">
            <img src ="images/Coronavirus.png " class ="img-fluid">
        </div>
   <div  class ="col-lg-6 col-md-6 col-12">
       <h2> What is COVID-19 (Corona-Virus)</h2>
       <p>COVID-19 is the infectious disease caused by mostly  recently discovered coronovirus. This new virus and disease were unknown before the outbreak began in Wuhan,China,in December 2019.  </p>
         <p>Coronaviruses are a large family of viruses which may cause illness in animals or humans. In humans , several coronoviruses are known to cause respiratory infections ranging from common cold to more severe diseases  such as Middle East Respiratory Syndrome(MERS) and Serve Acute Respiratory Syndrome (SARS).The most recently discovered coronovirus causes coronovirus disease COVID-19. </p>
   </div>
...
<div class ="Container-fluid  pt-5 pb-5" id="symid" >
    ...
    <div class="container">
        <div class ="row">
            ...
            <div class ="col-lg-4 col-md-4 col-12 mt-5" >
                <figure class="text-center">
                <img src="images/mucus.png" class="img-fluid " width="120" height="120" >
            ...
            <div class ="col-lg-4 col-md-4 col-12 mt-5" >
                <figure class="text-center">
                <img src="images/snizzing.png" class="img-fluid " width="120" height="120" >
...
<! - -/////////// Prevention Aganist Coronavirus////////  --->
<div class ="Container-fluid sub_section pt-5 pb-5" id="preventid" >
  ...
  <figure class="text-center">
            ...
            <div class ="col-lg-8 col-md-8 col-12">
             <p> Avoid close contact (1 meter or 3 feet) with who are unwell </p>
            </div>
  </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12 mt-5" >
  ...
  <div class ="col-lg-4 col-md-4 col-12">
  <figure class="text-center">
                <img src="images/news-reporter.png" class="img-fluid " width="90" height="90" >
                </figure>
  </div>
            <div class ="col-lg-8 col-md-8 col-12">
  ...
  <div class ="col-lg-4 col-md-4 col-12">
  <figure class="text-center">
                <img src="images/cough1.png" class="img-fluid " width="90" height="90" >
                </figure>
  </div>
            <div class ="col-lg-8 col-md-8 col-12">
...
<footer class = "mt-5">
<div class="footer_style text-white text-center conatiner-fluid" >
<p> @Copyright by Atharva Choudhari</p>
</div>
</footer>
